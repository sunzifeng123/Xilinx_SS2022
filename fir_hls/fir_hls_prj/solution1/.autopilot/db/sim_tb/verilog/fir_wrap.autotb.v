...
`define AUTOTB_TVIN_gmem  "./c.fir_wrap.autotvin_gmem.dat"
`define AUTOTB_TVIN_y  "./c.fir_wrap.autotvin_y.dat"
`define AUTOTB_TVIN_x  "./c.fir_wrap.autotvin_x.dat"
`define AUTOTB_TVIN_len  "./c.fir_wrap.autotvin_len.dat"
`define AUTOTB_TVIN_coef  "./c.fir_wrap.autotvin_coef.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.fir_wrap.autotvin_gmem.dat"
`define AUTOTB_TVIN_y_out_wrapc  "./rtl.fir_wrap.autotvin_y.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.fir_wrap.autotvin_x.dat"
`define AUTOTB_TVIN_len_out_wrapc  "./rtl.fir_wrap.autotvin_len.dat"
`define AUTOTB_TVIN_coef_out_wrapc  "./rtl.fir_wrap.autotvin_coef.dat"
`define AUTOTB_TVOUT_gmem  "./c.fir_wrap.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.fir_wrap.autotvout_gmem.dat"
module `AUTOTB_TOP;
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & control_write_data_finish & CTRL_write_data_finish;
